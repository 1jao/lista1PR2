    ...
    {
        {
            ...
            // 5- escolher uma fórmula da física e aplicar em um código (a escolhida foi a de velocidade)

            //Console.Write("Digite a distância percorrida pelo carro (em metros): ");
            ...
            //Console.WriteLine("A velocidade média é: {0} m/s", velocidade);
            ...
            // Console.Write("Digite quanto está a cotação do dólar: ");
            ...
            //Console.Write("Digite um número que seja inteiro e tenha 4 dígitos: ");
            //num = int.Parse(Console.ReadLine());
            ...
            // 12- peso ideal para homens e mulheres
